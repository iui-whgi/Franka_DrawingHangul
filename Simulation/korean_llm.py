...
def generate_korean_character(
    ...
    # final-tool_paths.json에서 문자 경로 가져오기
    ...
    if current_state == 0:
        ...
        print(f"distance start: {distance_to_start}")
        if distance_to_start <= 0.053:
            current_state = 1
        ...
        print(f"distance end: {distance_to_end}")
